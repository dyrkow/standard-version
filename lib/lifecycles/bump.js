...
const conventionalRecommendedBump = require('@dyrkow/conventional-recommended-bump')
  ...
  return new Promise((resolve, reject) => {
    if (releaseAs) {
      ...
      conventionalRecommendedBump({
        debug: args.verbose && console.info.bind(console, '@dyrkow/conventional-recommended-bump'),
